...
import com.traffic.secondkill.util.MD5Util;
import com.traffic.secondkill.util.UUIDUtil;
import com.traffic.secondkill.vo.LoginVo;

@Service
public class MiaoshaUserService {
	public static final String COOKI_NAME_TOKEN = "token";
	public static Logger log = LoggerFactory.getLogger(MiaoshaUserService.class);
